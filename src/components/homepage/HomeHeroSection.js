    ...
    <>
      <div className="max-w-2xl">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
          MERN Developer, Absolute JavaScrpt Enthusiast, and Tech Blogger.
        </h1>
        <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          I’m Bobby an enthusiastic and passionate MERN stack developer focused
          on crafting clean and user friendly experiences. Good hands in
          responsive Web Design and analyzing and fixing bugs quickly.
          Proficiency in code optimization to improve the performance.
        </p>
